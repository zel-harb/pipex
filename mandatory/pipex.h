...
/*   Updated: 2024/06/02 13:51:16 by zel-harb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		child_cmd4(char **av, t_pip *pip, char **env, int k);
void		null_env(char **av, t_pip *pip, char **env, int k);
void		check_pip(t_pip *pip);
void		child_cmd3(char **av, t_pip *pip, char **env, int k);
